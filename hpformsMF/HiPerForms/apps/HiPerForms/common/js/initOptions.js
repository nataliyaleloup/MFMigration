...
var wlInitOptions = {
	...
	onConnectionFailure: function () {
		throw new Error("Failed to connect to Worklight server");
	},
	...
	logger : {enabled: true, level: 'debug', stringify: true, pretty: false,
		tag: {level: true, pkg: true}, whitelist: [], blacklist: [], callback: Trasys.Hipermobile.MainController.loggerCallback},
