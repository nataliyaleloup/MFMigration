...
interface JQueryMobile extends JQueryMobileOptions {
    ...
    initializePage(): void;
    loadPage(url: any, options?: LoadPageOptions): JQueryPromise<any>;
    loading(): JQuery;
...
interface JQuery {
    ...
    collapsible(option: string, command: string, type: boolean): JQuery;
    collapsible(option: string, command: string, type: string): JQuery;
    ...
    checkboxradio(type: string, option:string, value:boolean): JQuery;
    ...
    panel(options: ListViewOptions): JQuery;
    panel(events: ListViewEvents): JQuery;

    jqmData(): any;
    jqmData(command: string): any;
    jqmData(options: ListViewOptions): any;
    jqmData(events: ListViewEvents): any;
